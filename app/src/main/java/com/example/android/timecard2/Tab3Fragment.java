...
public class Tab3Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        start = (Button) view.findViewById(R.id.btnStart3);
        pause = (Button) view.findViewById(R.id.btnPause3);
        reset = (Button) view.findViewById(R.id.btnReset3);
    ...
    protected void sendEmail(String time, String fDate) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Ashlie's Time");
