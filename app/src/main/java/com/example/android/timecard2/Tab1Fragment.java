...
public class Tab1Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        start = (Button) view.findViewById(R.id.btnStart1);
        pause = (Button) view.findViewById(R.id.btnPause1);
        reset = (Button) view.findViewById(R.id.btnReset1);
    ...
    protected void sendEmail(String time, String fDate) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Patricia's Time");
