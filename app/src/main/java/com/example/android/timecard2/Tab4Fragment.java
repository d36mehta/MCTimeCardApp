...
public class Tab4Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        start = (Button) view.findViewById(R.id.btnStart4);
        pause = (Button) view.findViewById(R.id.btnPause4);
        reset = (Button) view.findViewById(R.id.btnReset4);
    ...
    protected void sendEmail(String time, String fDate) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Krista's Time");
