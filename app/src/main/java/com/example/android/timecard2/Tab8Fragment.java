...
public class Tab8Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        start = (Button) view.findViewById(R.id.btnStart8);
        pause = (Button) view.findViewById(R.id.btnPause8);
        reset = (Button) view.findViewById(R.id.btnReset8);
    ...
    protected void sendEmail(String time, String fDate) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Bhavna's Time");
