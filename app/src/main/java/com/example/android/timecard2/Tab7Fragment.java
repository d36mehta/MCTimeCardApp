...
public class Tab7Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        start = (Button) view.findViewById(R.id.btnStart7);
        pause = (Button) view.findViewById(R.id.btnPause7);
        reset = (Button) view.findViewById(R.id.btnReset7);
    ...
    protected void sendEmail(String time, String fDate) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Aditya's Time");
