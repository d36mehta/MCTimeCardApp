...
public class Tab2Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        start = (Button) view.findViewById(R.id.btnStart2);
        pause = (Button) view.findViewById(R.id.btnPause2);
        reset = (Button) view.findViewById(R.id.btnReset2);
    ...
    protected void sendEmail(String time, String fDate) {
        ...
        String[] TO = {"mctimecard@gmail1883.com"};
        Intent emailIntent = new Intent(Intent.ACTION_SEND);
        emailIntent.setData(Uri.parse("mailto:"));
        emailIntent.setType("text/plain");

        emailIntent.putExtra(Intent.EXTRA_EMAIL, TO);
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Nicole's Time");
