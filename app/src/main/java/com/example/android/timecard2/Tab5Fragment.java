...
public class Tab5Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        start = (Button) view.findViewById(R.id.btnStart5);
        pause = (Button) view.findViewById(R.id.btnPause5);
        reset = (Button) view.findViewById(R.id.btnReset5);
    ...
    protected void sendEmail(String time, String fDate) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Rebecca's Time");
